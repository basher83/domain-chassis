...
const SYSTEM_PROMPT = [
	...
	"2. SMELL TEST (read cold): Read the Near-term step alone. Could it reasonably be read as the entire",
	"   endstate? If yes, the narrowing is silent — that is a finding.",
